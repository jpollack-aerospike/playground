...
public class dahp {
    ...
    private static Logger log = LogManager.getLogger(dahp.class);
    ...
    public static void main(String[] args) throws Exception {
	    ...
	    logUsage(options);
            ...
            IAerospikeClient client = new AerospikeClient(new ClientPolicy(), host, port);
	    AerospikeDocumentClient documentClient = new AerospikeDocumentClient(client);
	    Key key0 = new Key ("test", "s0", 1);

	    // client.get (
	    Object obj = documentClient.get (key0, "map", "$.payload");
	    String str = JsonConverters.writeValueAsString (obj);
	    log.debug("obj: {}", str);
